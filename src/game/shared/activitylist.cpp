...
//HL2 Beta Alyxgun
	...
	REGISTER_SHARED_ACTIVITY(ACT_SMG_TO_PISTOL);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SMGIDLE);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SMGDRAW);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SMGRELOAD);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SMGFIRE);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SMGFIRE1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SMGFIRE2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SMGFIRE2);
