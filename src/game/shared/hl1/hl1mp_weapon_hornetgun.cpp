...
#include "hl1/hl1_monster_hornet.h"
#endif
...
class CWeaponHgun : public CBaseCombatWeapon
{
	DECLARE_CLASS(CWeaponHgun, CBaseCombatWeapon);
public:
...
void CWeaponHgun::SecondaryAttack(void)
{
	...
	pHornet->SetThink(&CHL1Hornet::StartDart);
#endif
