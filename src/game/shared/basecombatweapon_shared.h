...
public:
	...
	virtual void            ProcessAnimationEvents(void);		//Lower vm while sprinting
	bool                    m_bWeaponIsLowered;					//Lower vm while sprinting
...
// Server Only Methods
	...
	void					EjectShell(CBaseEntity* pPlayer, int iType);		//HLS shell effect
