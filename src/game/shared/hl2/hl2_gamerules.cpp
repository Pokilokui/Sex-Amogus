...
ConVar sk_max_flash				( "sk_max_flash", "5", FCVAR_REPLICATED );
ConVar sk_max_gravity			( "sk_max_gravity", "16", FCVAR_REPLICATED );
...
ConVar sk_max_9mm_bullet("sk_plr_max_9mm_bullet", "0", FCVAR_REPLICATED);
...
ConVar sk_hl1_plr_dmg_crowbar("sk_hl1_plr_dmg_crowbar", "0", FCVAR_REPLICATED);

ConVar sk_hl1_plr_dmg_tripmine("sk_hl1_plr_dmg_tripmine", "0", FCVAR_REPLICATED);
ConVar sk_hl1_max_tripmine("sk_hl1_max_tripmine", "0", FCVAR_REPLICATED);
...
//		def.AddAmmoType("Extinguisher",		DMG_BURN,					TRACER_NONE,			0,	0, 100, 0, 0 );
		...
		def.AddAmmoType("Flash",			DMG_BURN,					TRACER_NONE,			"sk_plr_dmg_grenade",		"sk_npc_dmg_grenade",	"sk_max_flash",				0, 0);
	...
	//Beta
		...
		//HL1
		def.AddAmmoType("9mmRound", DMG_BULLET, TRACER_LINE_AND_WHIZ, "sk_plr_dmg_9mm_bullet", "sk_npc_dmg_9mm_bullet", "sk_plr_max_9mm_bullet", BULLET_IMPULSE(200, 1225), 0);
		...
		def.AddAmmoType("HL1_Buckshot", DMG_BULLET | DMG_BUCKSHOT, TRACER_LINE, "sk_plr_dmg_hl1_buckshot", NULL, "sk_max_hl1_buckshot", BULLET_IMPULSE(200, 1200), 0);
		...
		def.AddAmmoType("HL1_Grenade", DMG_BURN | DMG_BLAST, TRACER_NONE, "sk_plr_dmg_hl1_grenade", NULL, "sk_max_hl1_grenade", 0, 0);
	}
