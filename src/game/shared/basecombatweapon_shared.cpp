...
void CBaseCombatWeapon::EjectShell(CBaseEntity* pPlayer, int iType)			//Added from HLS code for shell ejection effect
{
...
void CBaseCombatWeapon::ItemPostFrame( void )
{
	...
	ProcessAnimationEvents();		//Lower vm while sprinting
	UpdateAutoFire();
