...
#include "mod/IMyPanel.h"		//custom panel
...
void VGui_CreateGlobalPanels( void )
{
	VPANEL gameToolParent = enginevgui->GetPanel( PANEL_CLIENTDLL_TOOLS );
	VPANEL toolParent = enginevgui->GetPanel( PANEL_TOOLS );
	//VPANEL gameParent = enginevgui->GetPanel(PANEL_CLIENTDLL);		//custom panel
	VPANEL GameUiDll = enginevgui->GetPanel(PANEL_GAMEUIDLL);
	PlayerModelPanel->Create(GameUiDll);
	//mypanel->Create(gameParent);	//custom panel
#if defined( TRACK_BLOCKING_IO )
	VPANEL gameDLLPanel = enginevgui->GetPanel( PANEL_GAMEDLL );
#endif
	// Part of game
...
void VGui_Shutdown()
{
	...
	PlayerModelPanel->Destroy();		//custom panel
