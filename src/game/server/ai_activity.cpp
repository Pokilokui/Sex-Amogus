...
//HL2 Beta Alyxgun
	...
	ADD_ACTIVITY_TO_SR(ACT_SMG_TO_PISTOL);
	ADD_ACTIVITY_TO_SR(ACT_VM_SMGIDLE);
	ADD_ACTIVITY_TO_SR(ACT_VM_SMGDRAW);
	ADD_ACTIVITY_TO_SR(ACT_VM_SMGRELOAD);
	ADD_ACTIVITY_TO_SR(ACT_VM_SMGFIRE);
	ADD_ACTIVITY_TO_SR(ACT_VM_SMGFIRE1);
	ADD_ACTIVITY_TO_SR(ACT_VM_SMGFIRE2);
	ADD_ACTIVITY_TO_SR(ACT_VM_SMGFIRE3);
