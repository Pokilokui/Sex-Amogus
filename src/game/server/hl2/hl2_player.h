...
public:
	...
	void				DropActiveWeapon(void);				// Weapon drop system.
	void				ApplyCustomHands();
...
private:
	...
	//kick
	bool				m_bInKickTime;
	float				m_fNextKickTime;
	float				m_fNextSwingTime;

	//CBaseViewModel* FindOrCreateKick();
	//float				KickSetAnimation(Activity act);
	//kick
