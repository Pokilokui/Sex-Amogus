...
#include "beta/grenade_molotov.h"
		...
		case COMBINE_AE_GREN_TOSS:
			{
				...
				else
				{
					...
					//Add possibility to throw molotov
					CGrenade_Molotov* pMolotov = (CGrenade_Molotov*)Create("grenade_molotov", vecStart, vec3_angle, this);	

					pMolotov->SetAbsVelocity(m_vecTossVelocity);
					pMolotov->SetLocalAngularVelocity(QAngle(random->RandomFloat(-100, -500), random->RandomFloat(-100, -500), random->RandomFloat(-100, -500)));
