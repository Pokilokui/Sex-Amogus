...
class CWeaponHL1Shotgun : public CBaseCombatWeapon
{
	DECLARE_CLASS( CWeaponHL1Shotgun, CBaseCombatWeapon );
...
acttable_t	CWeaponHL1Shotgun::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponHL1Shotgun);
