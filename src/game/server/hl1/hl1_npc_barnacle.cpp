...
ConVar	sk_hl1_barnacle_health("sk_hl1_barnacle_health", "25");
...
void CNPC_HL1Barnacle::Spawn()
{
	...
	SetModel("models/hl1/barnacle.mdl");
	...
	m_iHealth = sk_hl1_barnacle_health.GetFloat();
...
{
	PrecacheModel("models/hl1/barnacle.mdl");
