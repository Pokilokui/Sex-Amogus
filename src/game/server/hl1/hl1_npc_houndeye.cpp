...
BEGIN_DATADESC( CNPC_HL1Houndeye )
...
LINK_ENTITY_TO_CLASS( monster_hl1_houndeye, CNPC_HL1Houndeye );
...
/*void CNPC_HL1Houndeye::InitCustomSchedules(void)
{
	INIT_CUSTOM_AI(CNPC_HL1Houndeye);

	ADD_CUSTOM_TASK(CNPC_HL1Houndeye, TASK_HOUND_CLOSE_EYE);
	ADD_CUSTOM_TASK(CNPC_HL1Houndeye, TASK_HOUND_OPEN_EYE);
	ADD_CUSTOM_TASK(CNPC_HL1Houndeye, TASK_HOUND_THREAT_DISPLAY);
	ADD_CUSTOM_TASK(CNPC_HL1Houndeye, TASK_HOUND_FALL_ASLEEP);
	ADD_CUSTOM_TASK(CNPC_HL1Houndeye, TASK_HOUND_WAKE_UP);
	ADD_CUSTOM_TASK(CNPC_HL1Houndeye, TASK_HOUND_HOP_BACK);
	
	ADD_CUSTOM_SCHEDULE(CNPC_HL1Houndeye, SCHED_HOUND_CHASE_ENEMY);

	AI_LOAD_SCHEDULE(CNPC_HL1Houndeye, SCHED_HOUND_HOP_RETREAT);
	AI_LOAD_SCHEDULE(CNPC_HL1Houndeye, SCHED_HOUND_RANGE_ATTACK1);
	AI_LOAD_SCHEDULE(CNPC_HL1Houndeye, SCHED_HOUND_ATTACK_STRAFE);
	AI_LOAD_SCHEDULE(CNPC_HL1Houndeye, SCHED_HOUND_ATTACK_STRAFE_REVERSE);
	AI_LOAD_SCHEDULE(CNPC_HL1Houndeye, SCHED_HOUND_GROUP_ATTACK);
	AI_LOAD_SCHEDULE(CNPC_HL1Houndeye, SCHED_HOUND_GROUP_RETREAT);
	AI_LOAD_SCHEDULE(CNPC_HL1Houndeye, SCHED_HOUND_CHASE_ENEMY);
	AI_LOAD_SCHEDULE(CNPC_HL1Houndeye, SCHED_HOUND_COVER_WAIT);
	AI_LOAD_SCHEDULE(CNPC_HL1Houndeye, SCHED_HOUND_GROUP_RALLEY);
}*/

//=========================================================
// Spawn
//=========================================================
void CNPC_HL1Houndeye::Spawn()
{
	Precache( );
...
//=========================================================
void CNPC_HL1Houndeye::Precache()
{
	PrecacheModel("models/houndeye.mdl");

	m_iSpriteTexture = PrecacheModel( "hl1/sprites/shockwave.vmt" );
...
void CNPC_HL1Houndeye::Event_Killed( const CTakeDamageInfo &info )
{
...
int CNPC_HL1Houndeye::RangeAttack1Conditions ( float flDot, float flDist )
{
...
// IdleSound
//=========================================================
void CNPC_HL1Houndeye::IdleSound ( void )
{
...
// IdleSound
//=========================================================
void CNPC_HL1Houndeye::WarmUpSound ( void )
{
	CPASAttenuationFilter filter( this );
...
// WarnSound 
//=========================================================
void CNPC_HL1Houndeye::WarnSound ( void )
{
	CPASAttenuationFilter filter( this );
...
// AlertSound 
//=========================================================
void CNPC_HL1Houndeye::AlertSound ( void )
{
...
// DeathSound 
//=========================================================
void CNPC_HL1Houndeye::DeathSound( const CTakeDamageInfo &info )
{
	CPASAttenuationFilter filter( this );
...
// PainSound 
//=========================================================
void CNPC_HL1Houndeye::PainSound ( const CTakeDamageInfo &info )
{
	CPASAttenuationFilter filter( this );
...
//=========================================================
float CNPC_HL1Houndeye::MaxYawSpeed  ( void )
{
	int flYS;
...
// relationship table.
//=========================================================
Class_T	CNPC_HL1Houndeye::Classify ( void )
{
...
//=========================================================
void CNPC_HL1Houndeye::HandleAnimEvent( animevent_t *pEvent )
{
	switch ( pEvent->event )
	{
		case HOUND_AE_WARN:
...
// SonicAttack
//=========================================================
void CNPC_HL1Houndeye::SonicAttack ( void )
{
...
//=========================================================
Vector CNPC_HL1Houndeye::WriteBeamColor ( void )
{
...
bool CNPC_HL1Houndeye::ShouldGoToIdleState( void )
{
	if ( m_pSquad )
	{
		AISquadIter_t iter;
...
bool CNPC_HL1Houndeye::FValidateHintType ( CAI_Hint *pHint )
{
...
// SetActivity 
//=========================================================
void CNPC_HL1Houndeye::SetActivity ( Activity NewActivity )
{
	int	iSequence;
...
// start task
//=========================================================
void CNPC_HL1Houndeye::StartTask ( const Task_t *pTask )
{
	switch ( pTask->iTask )
	{
...
// RunTask 
//=========================================================
void CNPC_HL1Houndeye::RunTask ( const Task_t *pTask )
{
	switch ( pTask->iTask )
	{
	case TASK_HOUND_THREAT_DISPLAY:
...
// PrescheduleThink
//=========================================================
void CNPC_HL1Houndeye::PrescheduleThink ( void )
{
...
// GetScheduleOfType 
//=========================================================
int CNPC_HL1Houndeye::TranslateSchedule( int scheduleType ) 
{
	if ( m_fAsleep )
	{
...
int CNPC_HL1Houndeye::SelectSchedule( void )
{
	switch	( m_NPCState )
	{
...
// volume of the sound. 
//=========================================================
float CNPC_HL1Houndeye::FLSoundVolume( CSound *pSound )
{
...
AI_BEGIN_CUSTOM_NPC(monster_houndeye, CNPC_HL1Houndeye)
