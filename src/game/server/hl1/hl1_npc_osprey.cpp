...
//IMPLEMENT_CLIENTCLASS_DT(C_BaseHl1Helicopter, DT_BaseHL1Helicopter, CBaseHL1Helicopter)
//END_RECV_TABLE()
...
class CNPC_Osprey : public CBaseHL1Helicopter
{
	
public:
	DECLARE_CLASS(CNPC_Osprey, CBaseHL1Helicopter);
...
// Output  :
//------------------------------------------------------------------------------
BEGIN_DATADESC( CBaseHL1Helicopter )
...
//------------------------------------------------------------------------------
void CBaseHL1Helicopter::Precache( void )
{
}
...
// Notes   : Have your derived Helicopter's Spawn() function call this one FIRST
//------------------------------------------------------------------------------
void CBaseHL1Helicopter::Spawn( void )
{
	Precache( );
...
// Output  :
//------------------------------------------------------------------------------
bool CBaseHL1Helicopter::FireGun( void )
{
	return true;
}
...
// Output  :
//------------------------------------------------------------------------------
void CBaseHL1Helicopter::HelicopterThink( void )
{
...
// Output  :
//------------------------------------------------------------------------------
void CBaseHL1Helicopter::Hunt( void )
{
	FlyPathCorners( );
...
// Output  :
//------------------------------------------------------------------------------
void CBaseHL1Helicopter::FlyPathCorners( void )
{
...
// Output  :
//------------------------------------------------------------------------------
void CBaseHL1Helicopter::UpdatePlayerDopplerShift( )
{
	// -----------------------------
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
void CBaseHL1Helicopter::Flight( void )
{
...
// Output  :
//------------------------------------------------------------------------------
void CBaseHL1Helicopter::InitializeRotorSound( void )
{
	if (m_pRotorSound)
	{
		CSoundEnvelopeController &controller = CSoundEnvelopeController::GetController();
...
// Output  :
//------------------------------------------------------------------------------
void CBaseHL1Helicopter::UpdateRotorSoundPitch( int iPitch )
{
	if (m_pRotorSound)
	{
		CSoundEnvelopeController &controller = CSoundEnvelopeController::GetController();
...
// Output  :
//------------------------------------------------------------------------------
void CBaseHL1Helicopter::FlyTouch( CBaseEntity *pOther )
{
...
// Output  :
//------------------------------------------------------------------------------
void CBaseHL1Helicopter::CrashTouch( CBaseEntity *pOther )
{
...
// Output  :
//------------------------------------------------------------------------------
void CBaseHL1Helicopter::DyingThink( void )
{
	StudioFrameAdvance( );
	SetNextThink( gpGlobals->curtime + 0.1f );
...
// Output : 
//-----------------------------------------------------------------------------
int CBaseHL1Helicopter::OnTakeDamage_Alive( const CTakeDamageInfo &info )
{
#if 0
...
// Output : 
//-----------------------------------------------------------------------------
void CBaseHL1Helicopter::DrawDebugGeometryOverlays(void) 
{
	if (m_pfnThink!= NULL)
	{
		// ------------------------------
...
// Output : 
//-----------------------------------------------------------------------------
void CBaseHL1Helicopter::TraceAttack( const CTakeDamageInfo &info, const Vector &vecDir, trace_t *ptr )
{
...
// Output  :
//------------------------------------------------------------------------------
void CBaseHL1Helicopter::NullThink( void )
{
	StudioFrameAdvance( );
...
void CBaseHL1Helicopter::Startup( void )
{
	m_flGoalSpeed = m_flInitialSpeed;
	SetThink( &CBaseHL1Helicopter::HelicopterThink );
	SetTouch( &CBaseHL1Helicopter::FlyTouch );
	SetNextThink( gpGlobals->curtime + 0.1f );
}


void CBaseHL1Helicopter::Event_Killed( const CTakeDamageInfo &info )
{
	...
	SetThink( &CBaseHL1Helicopter::CallDyingThink );
	SetTouch( &CBaseHL1Helicopter::CrashTouch );
...
void CBaseHL1Helicopter::StopLoopingSounds()
{
	CSoundEnvelopeController &controller = CSoundEnvelopeController::GetController();
...
void CBaseHL1Helicopter::GibMonster( void )
{
}


void CBaseHL1Helicopter::ChangePathCorner( const char *pszName )
{
	if( m_lifeState != LIFE_ALIVE )
	{
...
//-----------------------------------------------------------------------------
void CBaseHL1Helicopter::InputChangePathCorner( inputdata_t &inputdata )
{
...
//-----------------------------------------------------------------------------
void CBaseHL1Helicopter::InputActivate( inputdata_t &inputdata )
{
	if( m_spawnflags & SF_AWAITINPUT )
	{
		Startup();
...
void CBaseHL1Helicopter::ApplySidewaysDrag( const Vector &vecRight )
{
...
// Output : 
//-----------------------------------------------------------------------------
void CBaseHL1Helicopter::ApplyGeneralDrag( void )
{
	Vector vecNewVelocity = GetAbsVelocity();
...
// Output : 
//-----------------------------------------------------------------------------
bool CBaseHL1Helicopter::ChooseEnemy( void )
{
...
// Output : 
//-----------------------------------------------------------------------------
void CBaseHL1Helicopter::CheckEnemy( CBaseEntity *pEnemy )
{
	// -------------------
	// If enemy is dead
	// -------------------
...
bool CBaseHL1Helicopter::HasReachedTarget( void )
{ 
